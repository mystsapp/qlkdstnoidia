...
namespace qlkdstDB.DAO
{
    public class tourDAO
    {
        ...
        public object ListAllPageList(string searchString, DateTime d1, DateTime d2, string tencongty, string sohopdong, string sChiNhanh, 
            string sDaily, users usr, string salenm, string tuyentq,string[] sCongTyPre, int page, int pagesize)
        {
