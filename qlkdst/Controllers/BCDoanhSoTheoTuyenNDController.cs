...
namespace qlkdst.Controllers
{
    public class BCDoanhSoTheoTuyenNDController : BaseController
    {
        ...
        public ActionResult Index(string tungay, string denngay, string dlcn,string loaitourid)
        {
            ...
            //List<TuyenTheoNgayDiTourViewModel> list = new List<TuyenTheoNgayDiTourViewModel>();
            //for (int i = 0; i <= tbl.Rows.Count; i++)
            //{
            //    TuyenTheoNgayDiTourViewModel vieTour = new TuyenTheoNgayDiTourViewModel();
            //    vieTour.sgtcode = tbl.Rows[i]["sgtcode"].ToString();
            //    vieTour.sohopdong = dao.GetSoHopDong(vieTour.sgtcode);
            //    vieTour.batdau = Convert.ToDateTime(tbl.Rows[i]["batdau"]);
            //    vieTour.ketthuc = Convert.ToDateTime(tbl.Rows[i]["ketthuc"]);
            //    vieTour.tuyentq = tbl.Rows[i]["tuyentq"].ToString();
            //    vieTour.sokhachtt = int.Parse(tbl.Rows[i]["sokhachtt"].ToString());
            //    vieTour.doanhthutt = decimal.Parse(tbl.Rows[i]["doanhthutt"].ToString());
            //    vieTour.trangthai = tbl.Rows[i]["trangthai"].ToString();
            //    vieTour.nguoitao = tbl.Rows[i]["nguoitao"].ToString();
            //    vieTour.tenkh = tbl.Rows[i]["tenkh"].ToString();
            //    vieTour.loaitourid = tbl.Rows[i]["loaitourid"].ToString();
            //    vieTour.nguontour = tbl.Rows[i]["nguontour"].ToString();
            //    vieTour.nganhnghe = tbl.Rows[i]["nganhnghe"].ToString();

            //    list.Add(vieTour);
            //}

            //var tblList = EntityToTable.ToDataTable(list);

            //ViewBag.tblList = tblList;

            return View(dt);
        }

        #region BCDoanhSoTheoNganhNghe
        // GET: BCDoanhSoTheoNganhNghe
        public ActionResult DoanhSoTheoNganhNghe(string tungay, string denngay, string dlcn, string NganhNghes)
        {
            string loaitourid = "";
            var dao = new baocaoDAO();
            // DateTime d1 = DateTime.Parse(DateTime.Now.ToString("yyyy") + "-1-1");
            ...
            ViewBag.NganhNghes = new SelectList(DungChung.LayDSNganhNghe(), "Value", "Text");
            ViewBag.NganhNghesSelected = NganhNghes;
            ...
            if (!string.IsNullOrEmpty(NganhNghes)) // moi load vao --> bo qua
            {
                var abc = NganhNghes.ToUpper();
                EnumerableRowCollection<DataRow> result = tbl.AsEnumerable().Where(myRow => myRow.Field<string>("Nganhnghe") == abc);
                var table = result.CopyToDataTable();

                dt.Tables[0].Clear();
                dt.Tables.Add(table); // table 4 ( co 5 table)
            }
            
            //var results = tbl.AsEnumerable();
        ...
        public ActionResult ExcelNganhNghe(string tungay, string denngay, string schinhanh, string NganhNghes)
        {
            string loaitourid = "";
            string Filename = "BCDSTheoNganhNghe_" + System.DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".xlsx";

            // Gọi lại hàm để tạo file excel
            var stream = CreateExcelNganhNghe(tungay, denngay, schinhanh, loaitourid, NganhNghes);
        ...
        private Stream CreateExcelNganhNghe(string tungay, string denngay, string schinhanh, string loaitourid, string NganhNghes, Stream stream = null)
        {
            DateTime d1 = DateTime.Parse(DateTime.Now.ToString("yyyy") + "-1-1");
            DateTime d2 = DateTime.Parse(DateTime.Now.ToString("yyyy") + "-12-31");
            ...
            DataSet list = GetDuLieuBCNganhNghe(d1, d2, schinhanh, loaitourid, NganhNghes);
            ...
            using (var excelPackage = new ExcelPackage(stream ?? new MemoryStream()))
            {
                ...
                workSheet = FormatWorkSheetNganhNghe(list, workSheet, d1, d2);
        ...
        private DataSet GetDuLieuBCNganhNghe(DateTime d1, DateTime d2, string schinhanh, string loaitourid, string NganhNghes)
        {
            var dao = new baocaoDAO();
            ...
            if (!string.IsNullOrEmpty(NganhNghes)) // moi load vao --> bo qua
            {
                ...
                ds.Tables[0].Clear();
                ds.Tables.Add(table); // table 4 ( co 5 table)
            }

            /////
            return ds;
        }
        public ExcelWorksheet FormatWorkSheetNganhNghe(DataSet ds, ExcelWorksheet ew, DateTime d1, DateTime d2)
        {
            ...
            ewres.Cells[2, 1].Value = "DOANH SỐ THEO NGÀY NGÀNH NGHỀ " + d1.ToString("dd/MM/yyyy") + " - " + d2.ToString("dd/MM/yyyy");
            ...
            ewres.Cells[4, 3].LoadFromText("Số HĐ");
            ewres.Cells[4, 4].LoadFromText("Ngày đi");
            ewres.Cells[4, 5].LoadFromText("Ngày về");
            ewres.Cells[4, 6].LoadFromText("Tuyến tham quan");
            ewres.Cells[4, 7].LoadFromText("Số khách");
            ewres.Cells[4, 8].LoadFromText("Doanh số");
            ewres.Cells[4, 9].LoadFromText("Sales");
            ewres.Cells[4, 10].LoadFromText("Tên công ty/Khách hàng");
            ewres.Cells[4, 11].LoadFromText("Loại tour");
            ewres.Cells[4, 12].LoadFromText("Nguồn tour");//add 11092019
            ewres.Cells[4, 13].LoadFromText("Ngành nghề");//add 18122019
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    ewres.Cells[iRowIndex, 3].Value = row["sohopdong"].ToString();
                    ...
                    ewres.Cells[iRowIndex, 4].Value = sbatdau;
                    ...
                    ewres.Cells[iRowIndex, 5].Value = sketthuc;
                    ...
                    ewres.Cells[iRowIndex, 6].Value = row["tuyentq"].ToString();
                    ...
                    ewres.Cells[iRowIndex, 7].Value = dSK;
                    ...
                    ewres.Cells[iRowIndex, 8].Value = dDoanhSo;
                    ...
                    ewres.Cells[iRowIndex, 9].Value = row["nguoitao"].ToString();
                    ...
                    ewres.Cells[iRowIndex, 10].Value = row["tenkh"].ToString();
                    ...
                    {
                        ewres.Cells[iRowIndex, 11].Value = row["loaitourid"].ToString().ToUpper();
                    }
                    else
                    {
                        ewres.Cells[iRowIndex, 11].Value = row["loaitourid"];
                    }
                    ...
                    ewres.Cells[iRowIndex, 12].Value = row["nguontour"].ToString();
                    ...
                    ewres.Cells[iRowIndex, 13].Value = row["nganhnghe"].ToString();
                    ewres.Cells[iRowIndex, 13].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 13, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Left, Color.Black, "Times New Roman", 12, FontStyle.Regular);
                ...
                ewres.Cells[iRowIndex, 8].Value = dTotal;
                ewres.Cells[iRowIndex, 8].Style.Numberformat.Format = "#,##0";
                ...
                ewres.Cells[iRowIndex, 13].Value = "";
                DungChung.TrSetCellBorder(ewres, iRowIndex, 13, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Left, Color.Black, "Times New Roman", 12, FontStyle.Regular);
                ...
                if (dt1.Rows.Count > 0)
                {
                    ...
                    ewres.Cells[iRowIndex, 6].Value = "Các đoàn đã thanh lý:";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Black, "Times New Roman", 12, FontStyle.Bold);
                    ewres.Cells[iRowIndex, 6].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    ewres.Cells[iRowIndex, 6].Style.Fill.BackgroundColor.SetColor(colorThanhLy);


                    ewres.Cells[iRowIndex, 7].Value = dt1.Rows[0]["sokhachtt"];
                    ewres.Cells[iRowIndex, 7].Style.Numberformat.Format = "#,##0";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Black, "Times New Roman", 12, FontStyle.Bold);

                    ewres.Cells[iRowIndex, 8].Value = dt1.Rows[0]["doanhthutt"];
                    ewres.Cells[iRowIndex, 8].Style.Numberformat.Format = "#,##0";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 8, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Black, "Times New Roman", 12, FontStyle.Bold);
                ...
                if (dt2.Rows.Count > 0)
                {
                    ...
                    ewres.Cells[iRowIndex, 6].Value = "Các đoàn chưa thanh lý:";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Black, "Times New Roman", 12, FontStyle.Bold);
                    ewres.Cells[iRowIndex, 6].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    ewres.Cells[iRowIndex, 6].Style.Fill.BackgroundColor.SetColor(Color.Yellow);


                    ewres.Cells[iRowIndex, 7].Value = dt2.Rows[0]["sokhachtt"];
                    ewres.Cells[iRowIndex, 7].Style.Numberformat.Format = "#,##0";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Black, "Times New Roman", 12, FontStyle.Bold);

                    ewres.Cells[iRowIndex, 8].Value = dt2.Rows[0]["doanhthutt"];
                    ewres.Cells[iRowIndex, 8].Style.Numberformat.Format = "#,##0";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 8, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Black, "Times New Roman", 12, FontStyle.Bold);
                ...
                if (dt3.Rows.Count > 0)
                {
                    ...
                    ewres.Cells[iRowIndex, 6].Value = "Các đoàn chưa ký hợp đồng:";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 6, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Center, Color.Black, "Times New Roman", 12, FontStyle.Bold);

                    ewres.Cells[iRowIndex, 7].Value = dt3.Rows[0]["sokhachtt"];
                    ewres.Cells[iRowIndex, 7].Style.Numberformat.Format = "#,##0";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 7, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Black, "Times New Roman", 12, FontStyle.Bold);

                    ewres.Cells[iRowIndex, 8].Value = dt3.Rows[0]["doanhthutt"];
                    ewres.Cells[iRowIndex, 8].Style.Numberformat.Format = "#,##0";
                    DungChung.TrSetCellBorder(ewres, iRowIndex, 8, ExcelBorderStyle.Thin, ExcelHorizontalAlignment.Right, Color.Black, "Times New Roman", 12, FontStyle.Bold);
