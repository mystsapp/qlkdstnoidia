...
namespace qlkdstDB.DAO
{
    public class baocaoDAO
    {
        ...
        public DataSet BCDoanhThuTheoSales(DateTime bdate, DateTime edate, string nguoitao, string roles, string sChinhanh, string sCongTyPre)
        {
            DataSet ds = new DataSet();
            string constr = ConfigurationManager.ConnectionStrings["strkhi_goiprocedure"].ConnectionString;
            using (SqlConnection sqlConn = new SqlConnection(constr))
        ...
        public DataSet BCDTTheoTuyenND(DateTime bdate, DateTime edate, string nguoitao, string roles, string chinhanh, string sCongTyPre)
        {
            DataSet ds = new DataSet();
            string constr = ConfigurationManager.ConnectionStrings["strkhi_goiprocedure"].ConnectionString;
            using (SqlConnection sqlConn = new SqlConnection(constr))
